...
from text.button_text import menu_text, submit_contacts_step, bonus_menu_text
...
async def generating_keyboard_bonus_menu():
    return await KeyboardFactory.get_markup(2, *bonus_menu_text, resize=True, persistent=True)